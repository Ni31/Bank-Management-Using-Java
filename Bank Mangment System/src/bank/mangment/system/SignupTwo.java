    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (t2.getText().equals("")) {
                ...
                String query = "INSERT INTO signuptwo (formno, religion, category, income, education, occupation, pan, aadhar, scitizen, eaccount) " +
                        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                JOptionPane.showMessageDialog(null, "Additional Details Submitted Successfully");
                 new SignupThree(formno).setVisible(true);

                setVisible(false); // Close the current frame after submission
