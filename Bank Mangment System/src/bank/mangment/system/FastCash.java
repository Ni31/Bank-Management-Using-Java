...
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash(String pin) {
        this.pin = pin;
        c = new Conn(); // Initialize Conn object for database connection
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            Connection conn = c.getCon(); // Get the Connection object from Conn
            ...
            if (ae.getSource() == b7) {
                ...
                pst.setString(1, pin);
                pst.setString(2, new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(date));
