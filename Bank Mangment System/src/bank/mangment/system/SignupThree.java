        ...
        try {
            if (ae.getSource() == b1) {
                ...
                if (atype == null || atype.isEmpty()) {
                    ...
                    String insertSignup3 = "INSERT INTO  signupthree (formno, accType, cardnumber, pin, facility) VALUES (?, ?, ?, ?, ?)";
                    PreparedStatement psSignup3 = con.prepareStatement(insertSignup3);
                    psSignup3.setString(1, formno);
                    psSignup3.setString(2, atype);
                    psSignup3.setString(3, cardno);
                    psSignup3.setString(4, pin);
                    psSignup3.setString(5, facility);
                    psSignup3.executeUpdate();

                    // Insert data into login table
                    String insertLogin = "INSERT INTO login (formno, cardno, pin) VALUES (?, ?, ?)";
                    PreparedStatement psLogin = con.prepareStatement(insertLogin);
                    psLogin.setString(1, formno);
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error while creating account. Please try again.");
        }
